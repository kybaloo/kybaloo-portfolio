...
export const enTranslations = {
  ...
  blog: {
    ...
    comingSoon: 'I\'m working on some interesting content. Check back soon for articles about web development, data analysis, and more!',
  },
  contact: {
    title: 'Get In Touch',
...
export const frTranslations = {
  ...
  blog: {
    ...
    comingSoon: 'Je travaille sur du contenu intéressant. Revenez bientôt pour des articles sur le développement web, l\'analyse de données et plus encore !',
  },
  contact: {
