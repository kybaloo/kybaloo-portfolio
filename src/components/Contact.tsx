            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-6">
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 rounded-lg dark:border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 dark:text-white"
              ...
              <button
                ...
                className="w-full px-6 py-3 font-medium text-white transition-all duration-200 bg-blue-600 rounded-lg hover:bg-blue-700 hover:shadow-lg hover:scale-105 disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
            ...
            <div className="p-8 bg-white shadow-md dark:bg-gray-800 rounded-xl">
              ...
              <div className="flex space-x-4">
                ...
                <a
                  ...
                  aria-label="GitHub"
                  className="p-3 transition-all duration-200 bg-gray-100 rounded-full dark:bg-gray-700 hover:bg-blue-500 dark:hover:bg-blue-600 hover:scale-110 group"
                >
                  <svg
                    className="w-6 h-6 text-gray-700 dark:text-gray-300 group-hover:text-white transition-colors"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                  >
                ...
                <a
                  ...
                  className="p-3 transition-all duration-200 bg-gray-100 rounded-full dark:bg-gray-700 hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-500 dark:hover:bg-gradient-to-r dark:hover:from-purple-600 dark:hover:to-pink-600 hover:scale-110 group"
                >
                  <svg
                    className="w-6 h-6 text-gray-700 dark:text-gray-300 group-hover:text-white transition-colors"
                    fill="currentColor"
