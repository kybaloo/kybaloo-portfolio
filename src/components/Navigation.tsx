      ...
      <div className="container px-4 mx-auto sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center">
            <motion.span
              className="text-xl font-bold text-transparent bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text"
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={toggleMenu}
              className="p-2 transition-colors rounded-lg md:hidden hover:bg-gray-100 dark:hover:bg-gray-800"
