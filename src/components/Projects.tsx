            ...
            {featuredProjects.map((project, index) => (
              ...
              >
                ...
                <div className="relative w-full overflow-hidden h-80">
                  ...
                  {/* Hover Icon */}
                  <div className="absolute transition-all duration-300 opacity-0 top-6 right-6 group-hover:opacity-100">
                    <div className="p-3 text-gray-800 rounded-full shadow-lg bg-white/90 hover:bg-white">
