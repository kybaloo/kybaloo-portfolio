      ...
      <div className="container px-4 mx-auto sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-12 md:flex-row">
          <div className="w-full md:w-1/2 animate-slide-up">
            ...
            <p className="max-w-lg mb-8 text-lg text-gray-600 dark:text-gray-300">
              {t.hero.description}
            </p>
            ...
            <div className="flex items-center gap-6 mt-12">
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                <svg className="w-6 h-6 text-gray-700 transition-colors dark:text-gray-300 hover:text-blue-500" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
