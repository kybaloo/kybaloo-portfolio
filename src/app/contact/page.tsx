      ...
      >
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <motion.div variants={itemVariants}>
                <button
                  ...
                  className="flex items-center justify-center w-full px-6 py-3 font-medium text-white transition-opacity rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 hover:opacity-90 disabled:opacity-70"
                >
                  {status === "sending" ? (
                    <>
                      <svg
              ...
              {status === "success" && (
                <motion.div
                  className="p-3 mt-4 text-green-700 bg-green-100 rounded-lg"
              ...
              {status === "error" && (
                <motion.div
                  className="p-3 mt-4 text-red-700 bg-red-100 rounded-lg"
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                >
          ...
          <motion.div variants={containerVariants} initial="hidden" animate="visible">
            <motion.div className="p-8 mb-8 bg-white shadow-lg dark:bg-gray-800 rounded-xl" variants={itemVariants}>
              <h2 className="mb-6 text-2xl font-bold">{t.contact.contactInfo}</h2>
              <div className="space-y-4">
                <div className="flex items-center">
                  <div className="flex items-center justify-center w-10 h-10 mr-4 bg-blue-100 rounded-full dark:bg-blue-900">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div>
                    ...
                    <a href="mailto:kybalooflo@gmail.com" className="font-medium hover:text-blue-500">
            ...
            <motion.div className="p-8 bg-white shadow-lg dark:bg-gray-800 rounded-xl" variants={itemVariants}>
              <h2 className="mb-6 text-2xl font-bold">{t.contact.followMe}</h2>
